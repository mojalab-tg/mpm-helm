...
{{- else }}
{{- include "haproxy.fullname" . }}-config
{{- end }}
{{- end }}
...
*/}}
{{- define "haproxy.secretsName" -}}
{{- if .Values.certificates.secrets.name }}
{{- .Values.certificates.secrets.name }}
{{- else }}
{{- include "haproxy.fullname" . }}-secrets
{{- end }}
{{- end }}